...
public class GridMoverOrcShaman : MonoBehaviour
{
    ...
    string GetIdleAnim(Direction dir) => "OrcShaman_Idle";
    string GetRunAnim() => "OrcShaman_Run";
    string GetAttackAnim() => "OrcShaman_Atack";
    string GetDeathAnim() => "OrcShaman_Death";
}