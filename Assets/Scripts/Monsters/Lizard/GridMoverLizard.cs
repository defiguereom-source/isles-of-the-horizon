...
public class GridMoverLizard : MonoBehaviour
{
    ...
    {
        Direction.Down => "Lizard_1",
        Direction.Up => "Lizard_2",
        Direction.Left => "Lizard_3",
        Direction.Right => "Lizard_4",
        _ => "Lizard_1"
    };
    ...
    // por "Lizard_1_Idle" etc. si las tienes).
